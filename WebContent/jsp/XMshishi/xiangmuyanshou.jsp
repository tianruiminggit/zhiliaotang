			...
			<table class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'yanshouchengyuan',align:'center'"
							width="200">验收成员</th>
		...
		<form method="post">
			...
			<div style="width: 100px; margin: 0 auto;">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					onclick="$('#dlg').dialog('open')">下一步1</a>
				<!-- <button>下一步</button> -->
				<button>返回</button>
			</div>
			<div id="dlg" class="easyui-dialog" title="Basic Dialog"
				...
				<form>
					<table>
						...
						<tr>
							<td>级别:</td>
							<td><input type="radio" name="level" value="" />验收组负责人 <input
								type="radio" name="level" value="" />复查组负责人 <input type="radio"
								name="level" value="" />成员</td>
						</tr>
					</table>
				</form>
			</div>
