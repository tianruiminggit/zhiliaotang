...
<body>
	...
	<div id="kuang" class="easyui-dialog" title="项目详情"
		...
		<form method="post">
			<table cellpadding="5" style="margin: 0 auto">
				...
				<tr>
					...
					<td><input class="easyui-textbox" type="text"
						name="project_name" data-options=""></input></td>
				</tr>
				<tr>
					<td>项目申报文件号:</td>
					<td><input class="easyui-textbox" type="text"
						name="project_filenum" data-options=""></input></td>
				</tr>
				<tr>
					<td>单位法人:</td>
					<td><input class="easyui-textbox" type="text"
						name="declar_lawer" data-options=""></input></td>
				</tr>
				<tr>
					<td>技术负责人:</td>
					<td><input class="easyui-textbox" type="text"
						name="technology" data-options=""></input></td>
				</tr>
				<tr>
					<td rowspan="4">预算:</td>
					<td>补助资金：<input class="easyui-textbox" type="text"
						name="buzhuzj" data-options=""></input>
					</td>
				</tr>
				<tr>
					<td>其他资金：<input class="easyui-textbox" type="text"
						name="othermoney" data-options=""></input>
					</td>
				</tr>
				<tr>
					<td>自筹资金：<input class="easyui-textbox" type="text"
						name="zichouzj" data-options=""></input>
					</td>
				</tr>
				<tr>
					<td>合&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：<input
				...
				<tr>
					<td>推荐文件号:</td>
					<td><input class="easyui-textbox" type="text"
						name="tuijianfile" data-options=""></input></td>
				</tr>
				<!--<tr>
	    			<td>Message:</td>
			...
			<div style="text-align: center; padding: 5px">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					onclick="submitForm()">提交</a> <a href="#" class="easyui-linkbutton"
